...
# ════════════════════════════════════════════════════════════════════════════
# 2. Ship count grouped by destination
# ════════════════════════════════════════════════════════════════════════════
st.subheader("2 · Ships by Destination (Top N)")
st.caption("Source: `ships_static_data`")
...
# ════════════════════════════════════════════════════════════════════════════
# 3. Ship count grouped by navigational_status
# ════════════════════════════════════════════════════════════════════════════
st.subheader("3 · Ships by Navigational Status")
...
# ════════════════════════════════════════════════════════════════════════════
# 4. Average speed_over_ground (> 0) grouped by ship_type  [join]
# ════════════════════════════════════════════════════════════════════════════
st.subheader("4 · Average Speed by Ship Type  (moving ships only)")
st.caption(
