"""
Ship Static Data DB Writer
==========================
Reads processed ship-static messages from the Kafka topic `ships_static_data`
(as produced by ship_static_data_processor.py) and upserts them into the
PostgreSQL table `ships_static_data`.
...
to keep write amplification low.

Expected message format (as produced by ship_static_data_processor.py):
    {
        ...
        "destination":  str,
        "eta":          str,    -- "MM-DD HH:MM UTC" or null
        "length_m":     int,
        "width_m":      int,
        "draught_m":    float,
...
Configuration (environment variables):
    ...
    SHIP_STATIC_DATA_OUTPUT_TOPIC       default: ships_static_data
    SHIP_STATIC_DATA_DB_CONSUMER_GROUP_ID  default: ships-static-data-consumer
    DB_HOST                             default: localhost
    DB_PORT                             default: 5432
    DB_NAME                             default: postgres
    DB_USER                             default: postgres
    DB_PASSWORD                         default: (empty)
    SHIP_STATIC_DATA_BATCH_SIZE         default: 500
"""
...
BATCH_SIZE = int(os.getenv("SHIP_STATIC_DATA_BATCH_SIZE", "500"))

# ---------------------------------------------------------------------------
# SQL
# ---------------------------------------------------------------------------
UPSERT_SQL = """
INSERT INTO ships_static_data (
    ship_id,
    ship_name,
    call_sign,
    imo_number,
...
def main() -> None:
    ...
    log.info(
        "Ship static data DB writer started. Reading from '%s', writing to 'ships_static_data'.",
        INPUT_TOPIC,
    )
